        ...
        setTimeout(() => {
            ...
            if (connection.request.url.match(/api\/userquestion/) && connection.request.method === RequestMethod.Post) {
                // get parameters from post request
                    ...
                    connection.mockRespond(new Response(new ResponseOptions({
                        status: 200,
                        body:{"id":"2c09640c-8447-4be5-a692-9139441715d2","isLastQuestionForCurrentQuiz":null,"CurrentUserQuestion":{"id":"2d25d568-dff5-43f2-93cf-1f2352005852","index":1,"isCorrect":null,"Question":{"description":"Question No 1 for Quiz 2","id":"6a122b17-a3a5-403a-8a9c-79b84095d518","optionType":"Radio","QuizOptions":[{"description":"Option 1 for Question 1 Quiz 2","id":"6a122b17-a3a5-403a-8a9c-79b84095a523","isCorrect":true,"index":0},{"description":"Option 2 for Question 1 Quiz 2","id":"6a122b17-a3a5-403a-8a9c-79b84095a524","isCorrect":false,"index":0},{"description":"Option 3 for Question 1 Quiz 2","id":"6a122b17-a3a5-403a-8a9c-79b84095a525","isCorrect":false,"index":0},{"description":"Option 4 for Question 1 Quiz 2","id":"6a122b17-a3a5-403a-8a9c-79b84095a526","isCorrect":false,"index":0}]},"questionId":"6a122b17-a3a5-403a-8a9c-79b84095d518","selectedOptionIds":null}}
                    })));
